...
function insertToDoData() {
    ...
    if ($todoText.value.trim() === '') {
        ...
        document.querySelector('.todo-insert').removeAttribute('style');
    }
...
function changeCheckState($checkbox) {
    ...
    */
    ...
    /*
    체크 이벤트가 일어난 체크박스의 li에 접근해서 data-id값을 얻어낸다면
    배열을 뒤져서 li의 data-id값과 해당 배열의 객체의 id값이 일치하는
    객체를 찾아내서 그 객체의 done의 논리값을 수정한다.
    */
    ...
    // 3. 배열을 탐색하여 data-id와 일치하는 id 프로퍼티를 가진 객체의 인덱스를 얻어옴
